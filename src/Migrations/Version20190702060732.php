 ...
 */
final class Version20190702060732 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE bibliotheque_recherche (id INT AUTO_INCREMENT NOT NULL, categorie VARCHAR(255) NOT NULL, culture_elevage VARCHAR(255) NOT NULL, localite_region VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE command (id INT AUTO_INCREMENT NOT NULL, relation_id INT DEFAULT NULL, user_id INT DEFAULT NULL, nom_commercial VARCHAR(255) NOT NULL, quantite INT NOT NULL, point_de_livraison VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, variete_race VARCHAR(255) NOT NULL, INDEX IDX_8ECAEAD43256915B (relation_id), INDEX IDX_8ECAEAD4A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE bibliotheque_recherche');
